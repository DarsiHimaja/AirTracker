...
export default function Home() {
  ...
  const handleCitySearch = (input, isSource = true) => {
    ...
    if (input.length === 3 && input.match(/^[A-Za-z]{3}$/)) {
  ...
  const selectCity = (city, isSource = true) => {
    const displayValue = `${city.name} (${city.code})`;
    if (isSource) {
      setSource(displayValue);
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Experience effortless flight search and instant booking</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Fast Search</h3>
              <p className="text-gray-600">Find the best flight deals across hundreds of routes instantly</p>
            </div>
            ...
            <div className="text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-gray-600">Seamless passenger details entry and instant e-ticket generation</p>
            </div>
